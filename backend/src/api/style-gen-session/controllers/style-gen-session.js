...
module.exports = createCoreController('api::style-gen-session.style-gen-session', ({ strapi }) => ({
    ...
    async create(ctx) {
        ...
        let session;
        try {
            session = await strapi.db.query('api::style-gen-session.style-gen-session').create({
                data: {
                    user: { id: user.id },
                    status: 'created',
                    source_images: [],
        ...
        try {
            ...
            await strapi.db.query('api::style-gen-session.style-gen-session').delete({ where: { id: session.id } }).catch(() => { });
    ...
    async confirmUploads(ctx) {
        ...
        const session = await strapi.db.query('api::style-gen-session.style-gen-session').findOne({
            where: { id: sessionId },
            populate: ['user'],
        });
    ...
    async getUserHistory(ctx) {
        ...
        const sessions = await strapi.db.query('api::style-gen-session.style-gen-session').findMany({
